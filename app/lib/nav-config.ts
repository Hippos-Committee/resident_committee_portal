...
export const NAV_ITEMS: NavItem[] = [
    ...
    { path: "/events", icon: "event", i18nKey: "nav.events", permission: "events:read" },
    { path: "/treasury", icon: "payments", i18nKey: "nav.treasury", permission: "treasury:read" },
    { path: "/minutes", icon: "description", i18nKey: "nav.minutes", permission: "minutes:read" },
    { path: "/inventory", icon: "inventory_2", i18nKey: "nav.inventory", permission: "inventory:read" },
    { path: "/social", icon: "forum", i18nKey: "nav.social", permission: "social:read", infoReelDuration: 16000 },
    // Auth items - shown conditionally
    { path: "/auth/login", icon: "login", i18nKey: "nav.login", showWhen: "logged-out" },
    // Submissions - requires submissions:read permission
    { path: "/submissions", icon: "mail", i18nKey: "nav.submissions", permission: "submissions:read" },
];
