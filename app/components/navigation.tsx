            ...
            {navItems.map((item) => {
                ...
                return (
                    <Link
                        ...
                        to={item.path}
                        className={cn(
                            "relative group flex items-center justify-center lg:justify-start gap-3 px-3 lg:px-4 py-2 rounded-xl transition-all duration-300",
                    ...
                    >
                        ...
                        <div className={cn(
                            "flex-col items-start leading-none hidden lg:flex",
